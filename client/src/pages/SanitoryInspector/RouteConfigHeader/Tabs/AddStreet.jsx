...
import { Search, Filter, X, Check, Edit, Trash, More } from "../../../../assets/icons/icons";
import AddStreetModal from "../../../../components/Modals/SanitaryInspector/AddStreet/AddStreetModal";
import StreetFilterModal from "../../../../components/Modals/SanitaryInspector/AddStreet/StreetFilterModal";
import MoveStreetModal from "../../../../components/Modals/SanitaryInspector/AddStreet/MoveStreetModal";
...
function AddStreet() {
    ...
    const [streets, setStreets] = useState([
        { id: 1, street_name: "Main Street", households: 45, route: "Route A", isDraft: false },
        { id: 2, street_name: "Gandhi Road", households: 38, route: "Route A", isDraft: false },
        { id: 3, street_name: "Temple Street", households: 52, route: "Route A", isDraft: false },
        { id: 4, street_name: "Park Avenue", households: 41, route: "Route B", isDraft: false },
        { id: 5, street_name: "Lake Road", households: 47, route: "Route B", isDraft: false },
        { id: 6, street_name: "School Street", households: 35, route: "Route B", isDraft: false },
        { id: 7, street_name: "Market Road", households: 60, route: "Route C", isDraft: false },
        { id: 8, street_name: "Station Road", households: 55, route: "Route C", isDraft: false },
        { id: 9, street_name: "College Street", households: 42, route: "Route D", isDraft: false },
        { id: 10, street_name: "Hospital Road", households: 48, route: "Route D", isDraft: false },
        { id: 11, street_name: "Industrial Street", households: 50, route: "Route E", isDraft: false },
        { id: 12, street_name: "Garden Street", households: 39, route: "Route E", isDraft: false },
        { id: 13, street_name: "North Street", households: 44, route: "Route F", isDraft: false },
        { id: 14, street_name: "South Street", households: 46, route: "Route F", isDraft: false },
        { id: 15, street_name: "East Street", households: 40, route: "Route G", isDraft: false },
    ]);
    ...
    const routes = useMemo(function() {
        ...
        { 
            id: 1, 
            name: "Route A", 
            streets: streets.filter(function(s) { return s.route === "Route A"; })
        },
        { 
            id: 2, 
            name: "Route B", 
            streets: streets.filter(function(s) { return s.route === "Route B"; })
        },
        { 
            id: 3, 
            name: "Route C", 
            streets: streets.filter(function(s) { return s.route === "Route C"; })
        },
        { 
            id: 4, 
            name: "Route D", 
            streets: streets.filter(function(s) { return s.route === "Route D"; })
        },
        { 
            id: 5, 
            name: "Route E", 
            streets: streets.filter(function(s) { return s.route === "Route E"; })
        },
        { 
            id: 6, 
            name: "Route F", 
            streets: streets.filter(function(s) { return s.route === "Route F"; })
        },
        { 
            id: 7, 
            name: "Route G", 
            streets: streets.filter(function(s) { return s.route === "Route G"; })
        },
        ];
    }, [streets]);
    ...
    const filteredStreets = streets.filter(function(street) {
        ...
        const matchesFilter = selectedRouteFilters.length === 0 || selectedRouteFilters.includes(street.route);
        return matchesSearch && matchesFilter;
    });

    function renderRouteCard(route) {
        const totalStreets = route.streets.length;
        const draftStreets = route.streets.filter(function(s) { return s.isDraft; }).length;
    ...
    function renderStreetCard(street) {
        ...
        >
            ...
            {!isEditing && (
                ...
                <button
                    onClick={() => { setOpenMenuId(menuOpen ? null : street.id); }}
                ...
                {menuOpen && (
                    <div className="absolute right-8 -top-8 mt-1 bg-white border border-secondary rounded-medium shadow-lg z-10 w-32">
                    <button
                        onClick={function() {
